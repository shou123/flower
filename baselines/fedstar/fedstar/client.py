...
class AudioClient(flwr.client.NumPyClient):  # pylint: disable=too-many-instance-attributes
    """AudioClient class act as a client for FedStar implementation.
    ...
    def __init__(
        ...
        self.model = ResNet50(
            input_shape=(224, 224, 3),  # Update based on your input data shape
            weights=None,  # Start with random weights or specify a pre-trained model
